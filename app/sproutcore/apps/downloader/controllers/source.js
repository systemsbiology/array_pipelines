// ==========================================================================
// Project:   Downloader.sourceController
 ...
 */
Downloader.sourceController = SC.TreeController.create(/** @scope Downloader.sourceController.prototype */
{
  ...
  populateContent: function(){
    ...
    Downloader.labGroupsController.forEach(function(labGroup){
      var children = [];
      
	  var projects = labGroup.get('projects').sortProperty('name');
      projects.forEach(function(project){
        if (project.get('status') !== SC.Record.ERROR) {
          children.push(Downloader.store.createRecord(Slimarray.NestedProject, {
